    ...
    dict(
        ...
        switch_pipeline=[
            ...
            dict(
                ...
                rotate_factor=60),
            dict(type='TopdownAffine', input_size=(512, 512)),
...
log_processor = dict(
    ...
    _scope_='mmpose')
log_level = 'INFO'
load_from = '/root/mmpose/work_dirs/rtmpose-s-ear/best_PCK_epoch_300.pth'
resume = False
...
data_mode = 'topdown'
data_root = '/root/autodl-tmp/Ear210_Keypoint_Dataset_coco/'
dataset_info = dict(
...
val_evaluator = [
    dict(
        type='CocoMetric',
        ann_file='/root/autodl-tmp/Ear210_Keypoint_Dataset_coco/val_coco.json'
    ),
...
launcher = 'none'
work_dir = './work_dirs/rtmpose-ear'
